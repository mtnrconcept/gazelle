                ...
                <section className={`${styles.storySection} reveal`} data-reveal="up">
                    <div className={styles.storyGrid}>
                        <div className={styles.storyText}>
                            ...
                            <p>
                                Niché au cœur du quartier des Grottes, au 55 rue de Lyon, notre établissement vous transporte instantanément dans un village africain. Des cases traditionnelles abritent des tables basses entourées de fauteuils en osier, flanqués de coussins colorés et de grandes corbeilles multicolores tissées à la main.
                            </p>
                            <p>
