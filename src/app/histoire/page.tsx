                ...
                <div className="container history-content">
                    <section className="history-storySection reveal organic-decor" data-reveal="up">
                        ...
                        <div className="history-storyGrid">
                            <div className="history-storyText">
                                ...
                                <h2 className="gold-sectionTitle history-sectionTitle" data-text="Une passion transmise de génération en génération">Une passion transmise de génération en génération</h2>
                    ...
                    <section className="history-valuesSection reveal" data-reveal="right">
                        <div className="history-valuesHeader">
                            ...
                            <h2 className="gold-sectionTitle history-sectionTitle" data-text="Ce qui nous définit">Ce qui nous définit</h2>
                        </div>
                        <div className="history-grid">
                            ...
                            <div className="history-card">
                                ...
                                <h3>Café et thé traditionnel</h3>
                    ...
                    <section className="history-ambianceSection reveal" data-reveal="right">
                        ...
                        <h2 className="gold-sectionTitle history-sectionTitle" data-text="Un décor qui vous transporte">Un décor qui vous transporte</h2>
